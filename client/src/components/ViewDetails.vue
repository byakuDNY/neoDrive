...
<template>
  <div class="space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div class="space-y-2">
          ...
          <div class="flex items-center space-x-2">
            <span class="text-sm bg-secondary-background px-2 py-1 rounded">{{ file.name }}</span>
            <Button
              size="sm"
              variant="neutral"
        ...
        <div class="space-y-2">
          ...
          <div class="flex items-center space-x-2">
            <span class="text-sm bg-secondary-background px-2 py-1 rounded">{{
              file.mimeType
            }}</span>
            <Button
              size="sm"
        ...
        <div class="space-y-2">
          ...
          <div class="flex items-center space-x-2">
            <span class="text-sm bg-secondary-background px-2 py-1 rounded break-all">{{
              file.path
            }}</span>
            <Button
              size="sm"
    ...
    <div class="pt-4 border-t">
      <Button @click="handleDownload" class="w-full">
        <Download class="mr-2" />
        Download
      </Button>
    </div>
